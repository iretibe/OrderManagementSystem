    ...
    public partial class OrderMigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "Name", "Segment" },
                values: new object[,]
                {
                    { new Guid("494bc8b2-e605-4019-b4bc-14d2d4a05dc7"), "Abdul Djalal", "VIP" },
                    { new Guid("66f79247-d93b-4765-a524-88ad3c6418ba"), "Abdul Manane", "Loyal" }
                });
